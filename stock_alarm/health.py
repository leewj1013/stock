...
def lines() -> list[str]:
    ...
    result = [
        ...
        f"SELL_ATR_MULTIPLIER={os.environ.get('SELL_ATR_MULTIPLIER', '2')}",
        f"SELL_TIME_STOP_DAYS={os.environ.get('SELL_TIME_STOP_DAYS', '10')}",
        f"SELL_TIME_STOP_MIN_RETURN_PCT={os.environ.get('SELL_TIME_STOP_MIN_RETURN_PCT', '0')}",
        f"EXECUTION_COST_BPS={os.environ.get('EXECUTION_COST_BPS', '30')}",
        f"PERFORMANCE_MIN_SAMPLES={os.environ.get('PERFORMANCE_MIN_SAMPLES', '20')}",
        ...
        f"FUNDAMENTAL_LOOKUP={enabled('FUNDAMENTAL_LOOKUP')}",
        task_error_status(),
